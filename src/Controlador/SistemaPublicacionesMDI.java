...
//Nombramos a los JInternal con un nuevo objeto para referirse a él.
public class SistemaPublicacionesMDI extends javax.swing.JFrame {
    ...
    /* Se declara la vista del MDI sobre los objetos de los JInternal Frame
        Para que puedan ser visualizadas en el desktopane que es la interfaz principal, 
        como una ventana interna.*/
    ...
    private void initComponents() {
        ...
        helpMenu.setText("Revista ");

        VerRevista.setMnemonic('c');
        VerRevista.setText("Ver Revista ");
        VerRevista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                VerRevistaActionPerformed(evt);
            }
        });
        helpMenu.add(VerRevista);
    ...
    private void exitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitMenuItemActionPerformed
        System.exit(0); //Utilizamos el metodo exit para terminar el programa 
    ...
    private void verAutorMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verAutorMenuItemActionPerformed
        ...
        Autores.obtenerDatos(); // llamamos al metodo obtener datos del JInternal para cargarlas en el formulario
        Autores.setVisible(true); //Hace que el objeto ventas que esta referenciada al JInterbal que pueda ser visible.
        // Así sucesivamente con las demas acciones que están en el MDI 
